...
def predict():
    ...
    # Here we decide what model to use based on the predicted distance_cline value. If the distance_cline value is within the range of e.g. .5 from 0, then we load model2
