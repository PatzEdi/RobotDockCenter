...
df = pl.read_csv(data_image_text_path) # We technically have all of the data here to train the model.
...
def get_data_targets(convert_targets_to_tensor=False):
...
data_targets = get_data_targets(True)
